...
window.deck = [
  ...
  {
    id: 82,
    name: "82: Subplot A — Part 1",
    type: "action",
    isSubplot: true,
    subplotId: "A",
    subplotStage: 1,
    subplotPosition: 15,
    description: "Subplot A: First special narrative event (this feature hasn't been added yet).\n\nWhat do you want to do?",
    tooltip: "Subplot A — Part 1",
    effect: function () {}
  },
  {
    id: 83,
    name: "83: Subplot A — Part 2",
    type: "action",
    isSubplot: true,
    subplotId: "A",
    subplotStage: 2,
    subplotPosition: 39,
    description: "Subplot A: Second special narrative event (this feature hasn't been added yet).\n\nYour options will depend on your previous choice.",
    tooltip: "Subplot A — Part 2",
    effect: function () {}
  },
  {
    id: 84,
    name: "84: Subplot A — Part 3",
    type: "action",
    isSubplot: true,
    subplotId: "A",
    subplotStage: 3,
    subplotPosition: 63,
    description: "Subplot A: Third special narrative event (this feature hasn't been added yet).\n\nYour options will depend on your previous choices.",
    tooltip: "Subplot A — Part 3",
    effect: function () {}
  },
  {
    id: 85,
    name: "85: Subplot B — Part 1",
    type: "action",
    isSubplot: true,
    subplotId: "B",
    subplotStage: 1,
    subplotPosition: 15,
    description: "Subplot B: First special narrative event (this feature hasn't been added yet).\n\nWhat do you want to do?",
    tooltip: "Subplot B — Part 1",
    effect: function () {}
  },
  {
    id: 86,
    name: "86: Subplot B — Part 2",
    type: "action",
    isSubplot: true,
    subplotId: "B",
    subplotStage: 2,
    subplotPosition: 39,
    description: "Subplot B: Second special narrative event (this feature hasn't been added yet).\n\nYour options will depend on your previous choice.",
    tooltip: "Subplot B — Part 2",
    effect: function () {}
  },
  {
    id: 87,
    name: "87: Subplot B — Part 3",
    type: "action",
    isSubplot: true,
    subplotId: "B",
    subplotStage: 3,
    subplotPosition: 63,
    description: "Subplot B: Third special narrative event (this feature hasn't been added yet).\n\nYour options will depend on your previous choices.",
    tooltip: "Subplot B — Part 3",
    effect: function () {}
  },
  {
    id: 88,
    name: "88: Subplot C — Part 1",
    type: "action",
    isSubplot: true,
    subplotId: "C",
    subplotStage: 1,
    subplotPosition: 15,
    description: "Subplot C: First special narrative event (this feature hasn't been added yet).\n\nWhat do you want to do?",
    tooltip: "Subplot C — Part 1",
    effect: function () {}
  },
  {
    id: 89,
    name: "89: Subplot C — Part 2",
    type: "action",
    isSubplot: true,
    subplotId: "C",
    subplotStage: 2,
    subplotPosition: 39,
    description: "Subplot C: Second special narrative event (this feature hasn't been added yet).\n\nYour options will depend on your previous choice.",
    tooltip: "Subplot C — Part 2",
    effect: function () {}
  },
  {
    id: 90,
    name: "90: Subplot C — Part 3",
    type: "action",
    isSubplot: true,
    subplotId: "C",
    subplotStage: 3,
    subplotPosition: 63,
    description: "Subplot C: Third special narrative event (this feature hasn't been added yet).\n\nYour options will depend on your previous choices.",
    tooltip: "Subplot C — Part 3",
    effect: function () {}
  },
  {
    id: 91,
    name: "91: Subplot D — Part 1",
    type: "action",
    isSubplot: true,
    subplotId: "D",
    subplotStage: 1,
    subplotPosition: 15,
    description: "Subplot D: First special narrative event (this feature hasn't been added yet).\n\nWhat do you want to do?",
    tooltip: "Subplot D — Part 1",
    effect: function () {}
  },
  {
    id: 92,
    name: "92: Subplot D — Part 2",
    type: "action",
    isSubplot: true,
    subplotId: "D",
    subplotStage: 2,
    subplotPosition: 39,
    description: "Subplot D: Second special narrative event (this feature hasn't been added yet).\n\nYour options will depend on your previous choice.",
    tooltip: "Subplot D — Part 2",
    effect: function () {}
  },
  {
    id: 93,
    name: "93: Subplot D — Part 3",
    type: "action",
    isSubplot: true,
    subplotId: "D",
    subplotStage: 3,
    subplotPosition: 63,
    description: "Subplot D: Third special narrative event (this feature hasn't been added yet).\n\nYour options will depend on your previous choices.",
    tooltip: "Subplot D — Part 3",
    effect: function () {}
  },
];
